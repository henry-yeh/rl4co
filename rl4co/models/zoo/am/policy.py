...
from rl4co.models.zoo.common.nonautoregressive import NonAutoregressivePolicy
...
class AttentionModelPolicy_NAR(NonAutoregressivePolicy):
    """Attention Model Policy based on Kool et al. (2019): https://arxiv.org/abs/1803.08475.
    We re-declare the most important arguments here for convenience as in the paper.
    See `AutoregressivePolicy` superclass for more details.
    ...
    def __init__(
        ...
        **kwargs,
        ...
        super(AttentionModelPolicy_NAR, self).__init__(
            env_name=env_name,
            embedding_dim=embedding_dim,
            num_encoder_layers=num_encoder_layers,
            num_heads=num_heads,
